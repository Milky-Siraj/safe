  ...
  return (
    <div className="bg-gray-100 min-h-screen">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-1/4">
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                {/* Price Range Filter */}
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-gray-700 mb-2">Price Range (ETB)</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-sm font-medium text-gray-700 mb-2">Minimum Seller Rating</h3>
                ...
                <button className="w-full py-2 bg-green-700 text-white rounded-md hover:bg-green-800 transition-colors">
                  Apply Filters
                </button>
              </div>
            </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="ml-1 text-sm">{product.seller.rating} ({product.seller.reviews})</span>
                        </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">Featured Sellers</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((seller) => (
              <div key={seller} className="bg-white rounded-lg shadow-md p-6 text-center">
                ...
                <h3 className="font-medium mb-1">Premium Seller {seller}</h3>
                <div className="flex items-center justify-center mb-2">
                  ...
                  <Star size={16} className="text-yellow-400" fill="currentColor" />
                  <Star size={16} className="text-yellow-400" fill="currentColor" />
                  <span className="ml-1 text-sm text-gray-600">(120)</span>
                </div>
                <p className="text-sm text-gray-600 mb-4">Specializes in Electronics</p>
                <button className="w-full py-2 text-sm bg-gray-100 text-gray-800 rounded-md hover:bg-gray-200 transition-colors">
                  View Profile
                </button>
              </div>
            ))}
