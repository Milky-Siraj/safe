          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                <img 
                  src="https://images.unsplash.com/photo-1507152832244-10d45c7eda57?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80" 
                  alt="User" 
              ...
              <p className="text-gray-600">
                "SAFE TRADE ETHIOPIA has transformed how I do business. I no longer worry about payment security when selling my products online."
              </p>
            </motion.div>
            <motion.div 
              className="bg-white rounded-lg p-8 shadow-md"
            ...
            >
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h4 className="font-bold">Sara Haile</h4>
                  <p className="text-gray-600 text-sm">Online Shopper</p>
                </div>
              </div>
              <p className="text-gray-600">
                "As a buyer, I feel protected knowing my money is held safely until I receive and approve the product. The process is simple and secure."
              </p>
            </motion.div>
            <motion.div 
              className="bg-white rounded-lg p-8 shadow-md"
            ...
            >
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h4 className="font-bold">Dawit Mengistu</h4>
                  <p className="text-gray-600 text-sm">Real Estate Agent</p>
                </div>
              </div>
              <p className="text-gray-600">
                "The escrow service has been invaluable for my real estate transactions. It provides peace of mind for both parties during property sales."
              </p>
            </motion.div>
          </div>
        </div>
